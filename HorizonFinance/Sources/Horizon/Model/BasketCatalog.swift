...
enum BasketCatalog {
    ...
    static let updatedAt = "сентябрь 2026"

    /// На чём выверены объёмы: месячный расход по корзине должен попадать
    /// в диапазон официальной статистики домохозяйств, а не быть «минимальным набором».
    static let calibrationNote =
        "Объёмы сверены с Encuesta de Presupuestos Familiares (INE, 2025): €5 626 в год "
        + "на еду и безалкогольные напитки на домохозяйство — около €469 в месяц."
    ...
    static let products: [BasketProduct] = [
        ...
        BasketProduct(id: "milk", name: "Молоко", unit: "1 л", category: .dairy,
                      basePrice: 1.05, perAdult: 7, perChild: 9),
        BasketProduct(id: "yogurt", name: "Йогурт натуральный", unit: "уп. 4×125 г", category: .dairy,
                      basePrice: 1.55, perAdult: 3, perChild: 5),
        BasketProduct(id: "cheese", name: "Сыр полутвёрдый", unit: "200 г", category: .dairy,
                      basePrice: 3.10, perAdult: 2.4, perChild: 1.8),
        BasketProduct(id: "kefir", name: "Кефир и творог", unit: "500 г", category: .dairy,
                      basePrice: 1.75, perAdult: 2, perChild: 2),
        BasketProduct(id: "butter", name: "Сливочное масло", unit: "250 г", category: .dairy,
                      basePrice: 2.90, perAdult: 0.8, perChild: 0.5),
        BasketProduct(id: "eggs", name: "Яйца", unit: "уп. 12 шт", category: .dairy,
                      basePrice: 3.20, perAdult: 2, perChild: 1.4),

        // Мясо и рыба
        BasketProduct(id: "chicken", name: "Куриное филе", unit: "кг", category: .meat,
                      basePrice: 7.60, perAdult: 2, perChild: 1),
        BasketProduct(id: "pork", name: "Свинина", unit: "кг", category: .meat,
                      basePrice: 7.60, perAdult: 1, perChild: 0.4),
        BasketProduct(id: "beefmince", name: "Фарш говяжий", unit: "кг", category: .meat,
                      basePrice: 10.50, perAdult: 0.8, perChild: 0.5),
        BasketProduct(id: "fish", name: "Рыба свежая", unit: "кг", category: .meat,
                      basePrice: 11.50, perAdult: 0.9, perChild: 0.4),
        BasketProduct(id: "frozenfish", name: "Заморозка и полуфабрикаты", unit: "упаковка", category: .meat,
                      basePrice: 6.90, perAdult: 1.2, perChild: 0.8),
        BasketProduct(id: "sausage", name: "Колбаса и сосиски", unit: "300 г", category: .meat,
                      basePrice: 3.60, perAdult: 1.5, perChild: 1),
        BasketProduct(id: "ham", name: "Ветчина нарезка", unit: "100 г", category: .meat,
                      basePrice: 2.10, perAdult: 2, perChild: 1.5),

        // Овощи и фрукты
        BasketProduct(id: "potato", name: "Картофель", unit: "кг", category: .produce,
                      basePrice: 1.35, perAdult: 3, perChild: 1.5),
        BasketProduct(id: "tomato", name: "Помидоры", unit: "кг", category: .produce,
                      basePrice: 2.40, perAdult: 2.2, perChild: 1),
        BasketProduct(id: "cucumber", name: "Огурцы", unit: "кг", category: .produce,
                      basePrice: 1.80, perAdult: 1, perChild: 0.6),
        BasketProduct(id: "onion", name: "Лук и чеснок", unit: "кг", category: .produce,
                      basePrice: 1.45, perAdult: 1, perChild: 0.3),
        BasketProduct(id: "carrot", name: "Морковь", unit: "кг", category: .produce,
                      basePrice: 1.25, perAdult: 1, perChild: 0.6),
        BasketProduct(id: "pepper", name: "Перец и кабачки", unit: "кг", category: .produce,
                      basePrice: 2.60, perAdult: 1.2, perChild: 0.5),
        BasketProduct(id: "salad", name: "Салат и зелень", unit: "упаковка", category: .produce,
                      basePrice: 1.50, perAdult: 2, perChild: 0.5),
        BasketProduct(id: "banana", name: "Бананы", unit: "кг", category: .produce,
                      basePrice: 1.75, perAdult: 1.8, perChild: 2),
        BasketProduct(id: "apple", name: "Яблоки", unit: "кг", category: .produce,
                      basePrice: 2.10, perAdult: 1.8, perChild: 2),
        BasketProduct(id: "orange", name: "Апельсины", unit: "кг", category: .produce,
                      basePrice: 1.55, perAdult: 2.2, perChild: 1.5),
        BasketProduct(id: "berries", name: "Ягоды и сезонные фрукты", unit: "упаковка", category: .produce,
                      basePrice: 2.80, perAdult: 1.5, perChild: 1.5),
        BasketProduct(id: "frozenveg", name: "Овощи замороженные", unit: "1 кг", category: .produce,
                      basePrice: 2.40, perAdult: 1, perChild: 0.8),

        // Бакалея
        BasketProduct(id: "bread", name: "Хлеб", unit: "буханка", category: .grocery,
                      basePrice: 1.25, perAdult: 8, perChild: 5),
        ...
        BasketProduct(id: "pasta", name: "Паста", unit: "500 г", category: .grocery,
                      basePrice: 1.20, perAdult: 2, perChild: 1.5),
        BasketProduct(id: "legumes", name: "Бобовые и консервы", unit: "банка", category: .grocery,
                      basePrice: 1.30, perAdult: 3, perChild: 1.5),
        BasketProduct(id: "flour", name: "Мука", unit: "1 кг", category: .grocery,
                      basePrice: 0.95, perAdult: 0.5, perChild: 0.3),
        BasketProduct(id: "sugar", name: "Сахар", unit: "1 кг", category: .grocery,
                      basePrice: 1.30, perAdult: 0.4, perChild: 0.3),
        BasketProduct(id: "oliveoil", name: "Оливковое масло", unit: "1 л", category: .grocery,
                      basePrice: 9.20, perAdult: 0.8, perChild: 0.3),
        BasketProduct(id: "tuna", name: "Тунец консервированный", unit: "уп. 3 шт", category: .grocery,
                      basePrice: 3.30, perAdult: 1.5, perChild: 0.6),
        BasketProduct(id: "olives", name: "Оливки и закуски", unit: "упаковка", category: .grocery,
                      basePrice: 2.40, perAdult: 1.2, perChild: 0.4),
        BasketProduct(id: "nuts", name: "Орехи и сухофрукты", unit: "упаковка", category: .grocery,
                      basePrice: 3.80, perAdult: 0.8, perChild: 0.5),
        BasketProduct(id: "jam", name: "Джем и мёд", unit: "банка", category: .grocery,
                      basePrice: 3.20, perAdult: 0.5, perChild: 0.5),
        BasketProduct(id: "chocolate", name: "Шоколад", unit: "плитка", category: .grocery,
                      basePrice: 2.10, perAdult: 2, perChild: 2),
        BasketProduct(id: "oats", name: "Овсянка", unit: "500 г", category: .grocery,
                      basePrice: 1.60, perAdult: 1, perChild: 1.5),
        BasketProduct(id: "cereal", name: "Хлопья и мюсли", unit: "упаковка", category: .grocery,
                      basePrice: 3.20, perAdult: 0.5, perChild: 1.5),
        BasketProduct(id: "coffee", name: "Кофе молотый", unit: "250 г", category: .grocery,
                      basePrice: 4.20, perAdult: 1, perChild: 0),
        BasketProduct(id: "tea", name: "Чай", unit: "20 пакетиков", category: .grocery,
                      basePrice: 1.90, perAdult: 0.6, perChild: 0.2),
        BasketProduct(id: "sweets", name: "Печенье и выпечка", unit: "упаковка", category: .grocery,
                      basePrice: 2.60, perAdult: 2, perChild: 3),
        BasketProduct(id: "sauces", name: "Соусы и специи", unit: "упаковка", category: .grocery,
                      basePrice: 2.20, perAdult: 1.5, perChild: 0.4),

        // Напитки
        BasketProduct(id: "water", name: "Вода питьевая", unit: "уп. 6×1,5 л", category: .drinks,
                      basePrice: 2.60, perAdult: 1.5, perChild: 1),
        BasketProduct(id: "juice", name: "Сок", unit: "1 л", category: .drinks,
                      basePrice: 1.60, perAdult: 1.5, perChild: 3),
        BasketProduct(id: "soda", name: "Газировка и лимонад", unit: "уп. 6×2 л", category: .drinks,
                      basePrice: 3.60, perAdult: 0.8, perChild: 1),
        BasketProduct(id: "alcohol", name: "Пиво или вино", unit: "упаковка", category: .drinks,
                      basePrice: 4.80, perAdult: 1.5, perChild: 0),

        // Бытовое и гигиена
        BasketProduct(id: "detergent", name: "Стиральный порошок", unit: "уп. ~20 стирок", category: .household,
                      basePrice: 6.50, perAdult: 0.4, perChild: 0.5),
        BasketProduct(id: "softener", name: "Кондиционер для белья", unit: "флакон", category: .household,
                      basePrice: 3.40, perAdult: 0.4, perChild: 0.4),
        BasketProduct(id: "shower", name: "Гель для душа", unit: "600 мл", category: .household,
                      basePrice: 2.60, perAdult: 0.8, perChild: 0.6),
        BasketProduct(id: "shampoo", name: "Шампунь", unit: "400 мл", category: .household,
                      basePrice: 3.00, perAdult: 0.6, perChild: 0.4),
        BasketProduct(id: "deodorant", name: "Дезодорант", unit: "штука", category: .household,
                      basePrice: 3.20, perAdult: 1, perChild: 0.2),
        BasketProduct(id: "razors", name: "Бритвы и пена", unit: "упаковка", category: .household,
                      basePrice: 4.80, perAdult: 0.6, perChild: 0),
        BasketProduct(id: "hygiene", name: "Средства личной гигиены", unit: "упаковка", category: .household,
                      basePrice: 4.20, perAdult: 0.8, perChild: 0.3),
        BasketProduct(id: "toiletpaper", name: "Туалетная бумага", unit: "8 рулонов", category: .household,
                      basePrice: 4.60, perAdult: 0.7, perChild: 0.4),
        BasketProduct(id: "toothpaste", name: "Зубная паста и щётки", unit: "упаковка", category: .household,
                      basePrice: 2.40, perAdult: 0.5, perChild: 0.5),
        BasketProduct(id: "dishsoap", name: "Средство для посуды", unit: "флакон", category: .household,
                      basePrice: 1.90, perAdult: 0.5, perChild: 0.2),
        BasketProduct(id: "cleaner", name: "Средства для уборки", unit: "флакон", category: .household,
                      basePrice: 2.70, perAdult: 0.6, perChild: 0.3),
        BasketProduct(id: "kitchenstuff", name: "Губки, фольга, пакеты", unit: "упаковка", category: .household,
                      basePrice: 2.30, perAdult: 0.8, perChild: 0.2),
        BasketProduct(id: "trashbags", name: "Мусорные пакеты", unit: "20 шт", category: .household,
                      basePrice: 1.80, perAdult: 0.5, perChild: 0.3),
        BasketProduct(id: "pharmacy", name: "Аптечка и витамины", unit: "упаковка", category: .household,
                      basePrice: 6.50, perAdult: 0.6, perChild: 0.6),

        // Детское
        BasketProduct(id: "diapers", name: "Подгузники", unit: "уп. 30–40 шт", category: .baby,
                      basePrice: 9.50, perAdult: 0, perChild: 4, onlyForAges: [.infant]),
        BasketProduct(id: "wipes", name: "Влажные салфетки", unit: "уп. 3 пачки", category: .baby,
                      basePrice: 2.70, perAdult: 0, perChild: 2, onlyForAges: [.infant, .preschool]),
        BasketProduct(id: "babyfood", name: "Детское пюре", unit: "уп. 4×100 г", category: .baby,
                      basePrice: 2.90, perAdult: 0, perChild: 8, onlyForAges: [.infant]),
        BasketProduct(id: "formula", name: "Детская смесь", unit: "800 г", category: .baby,
                      basePrice: 16.50, perAdult: 0, perChild: 1.5, onlyForAges: [.infant]),
        BasketProduct(id: "snacks", name: "Перекусы в школу", unit: "уп.", category: .baby,
                      basePrice: 2.60, perAdult: 0, perChild: 4, onlyForAges: [.preschool, .school])
    ]
