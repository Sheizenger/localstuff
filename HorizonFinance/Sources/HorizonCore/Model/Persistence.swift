...
public enum Persistence {
    ...
    public static let folderName = "Horizon"
    public static let fileName = "horizon-data.json"
    ...
    public static func load() -> AppData? {
    ...
    @discardableResult
    public static func save(_ data: AppData) -> Bool {
        do {
    ...
    public static func export(_ data: AppData, to url: URL) throws {
        let raw = try makeEncoder().encode(data)
        try raw.write(to: url, options: .atomic)
    }

    public static func importData(from url: URL) throws -> AppData {
